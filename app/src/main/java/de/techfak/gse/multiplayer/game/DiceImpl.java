...
public class DiceImpl implements Dice {
    ...
    public DiceResult roll() {
        final List<DieColor> rolledColors = new ArrayList<>();
        final List<DieNumber> rolledNumbers = new ArrayList<>();
        final List<DieColor> colors = Arrays.asList(DieColor.values());
        final List<DieNumber> numbers = Arrays.asList(DieNumber.values());
